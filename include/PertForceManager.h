...
public:
  ...
  //   * interactions
  //   */
  //  void addForceManager(std::shared_ptr<ForceManager> fmIn, float
  //  lambdaElecIn);
  //
  //
  //  /**
  ...
  //   * "children", for each step (except the first) of the alchemical
  //   schedule,
  //   * creates a ForceManager matching the lambda values, and adds it to the
  //   children .
  //   */
