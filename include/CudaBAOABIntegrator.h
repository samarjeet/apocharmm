...
public:
   ...
   */
  CudaBAOABIntegrator(ts_t timeStep, double bathTemperature, double friction);
  ~CudaBAOABIntegrator();
...
private:
  ...
  std::string integratorTypeName = "BAOAB";
};
