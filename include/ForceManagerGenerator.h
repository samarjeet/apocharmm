 ...
 */
class AlchemicalForceManagerGenerator
  : public ForceManagerGenerator {
public:
   /**
    * @brief Base constructor.
    */
    ...
    */
   AlchemicalForceManagerGenerator(std::shared_ptr<ForceManager> baseForceManager);
   /**
   ...
   /**
    * @brief Generate a SINGLE ForceManager following arguments. Specific to alchemical.
    *
    ...
    */
   std::shared_ptr<ForceManager> generateForceManager(double lambdaElecIn, double lambdaVdWIn);
    ...
    */
   void modifyElectrostatics(std::shared_ptr<ForceManager> fmIn, double lambdaIn);
